...
# Install vault
RUN curl "https://releases.hashicorp.com/vault/1.4.2/vault_1.4.2_linux_amd64.zip" \
	-o "vault.zip" \
	&& unzip vault.zip \
	&& mv vault bin/ \
	&& rm -rf vault.zip
...
# Install helm
RUN curl "https://get.helm.sh/helm-v2.16.7-linux-amd64.tar.gz" \
	-o "helm.tar.gz" \
	&& tar xvf helm.tar.gz \
	&& mv linux-amd64/helm bin/ \
	&& rm -rf linux-amd64 helm.tar.gz

# Install vessels-ovpn-generator
RUN curl -o bin/vessels-ovpn-generator-linux \
